  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-xl border border-gray-100">
        ...
        {/* Link to Sign Up */}
        <div className="mt-6 text-center text-sm font-medium text-gray-500 border-t pt-6">
           Don't have an account? <Link href="/auth/signup" className="text-black font-bold hover:underline">Create one</Link>
        </div>
